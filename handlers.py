...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        ...
        "📷 Просто отправь фото — CV-модель iNaturalist определит вид, "
        "а я расскажу о нём подробно на русском языке.\n\n"
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    text = (
        ...
        "птицы, паука — CV-модель iNaturalist определит вид, "
        "языковая модель Groq расскажет о нём подробно.\n\n"
        "*Лимиты:*\n"
